...
namespace DB\MaintenanceMode\Controller\Adminhtml\AdjustSettings;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
		...
		\DB\MaintenanceMode\Helper\Data $helper
	)
    {
   ...
   public function execute()
   {
    ...
    {
        return $this->_authorization->isAllowed('DB_MaintenanceMode::manage503');
    }
}